...
public class TransformationAggregate {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * 滚动聚合
         */
        // DataStream<SensorReading> outStream = keyedStream.sum("temperature");
        // DataStream<SensorReading> outStream = keyedStream.max("temperature");
        DataStream<SensorReading> outStream = keyedStream.maxBy("temperature");
